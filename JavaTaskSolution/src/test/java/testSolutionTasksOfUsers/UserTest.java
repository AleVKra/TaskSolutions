package testSolutionTasksOfUsers;
...
import solutionTasks.listOfUsersAssignedTasks.Sex;
import solutionTasks.listOfUsersAssignedTasks.User;
...
//создаем тестовые данные, точно такие же,
// что внесены в основном методе (копируем от туда данные)
...
// которые занесены в основном методе
